...
public class FakeTxBuilder {
    ...
    /**
     * Transaction[0] is a feeder transaction, supplying XPY to Transaction[1]
     */
    public static Transaction[] createFakeTx(NetworkParameters params, Coin value,
                                             Address to, Address from) {
        // Create fake TXes of sufficient realism to exercise the unit tests. This transaction send XPY from the
